	...
	#define MODE_ADMIN 6
	#define MODE_SPECIAL_AUDIO_DRAMA 7
	#define MODE_SPECIAL_ALBUM 8
	#define MODE_SPECIAL_PARTY 9
  	#define MODE_SPECIAL_AUDIO_BOOK 10
	#define MODE_PROGRAMMING 11
	...
	#define MODIFIER_REPEAT_SINGLE 6
	#define MODIFIER_LEARN_TO_CALC 7
	...
	#define MENU_SUB_LOCK_ADMIN 12
  	#define MENU_SUB_LIGHT 13
	#define MENU_SUB_LIGHT_BRIGHTNESS 14
	#define MENU_SUB_PROGRAMMING_MODE 15

	// advert files
	// 1-255 are numbers only
	#define ADV_LOCKED_SOUND 261
	#define ADV_MODIFIER_REMOVED_SOUND 260
	#define ADV_MINUTE 270
	#define ADV_MINUTES 271
	...
	#define MP3_SPECIAL_PARTY 319
  	#define MP3_SPECIAL_AUDIO_BOOK 320
	#define MP3_SELECT_FILE 321
	#define MP3_SELECT_FIRST_FILE 322
	#define MP3_SELECT_LAST_FILE 323
	#define MP3_PROGRAMMING_MODE_INTRO 325
	#define MP3_PROGRAMMING_MODE_ACTIVATED 326
	#define MP3_PROGRAMMING_MODE_FINISHED 327
	...
	#define MP3_CALC_INTRO 410
	#define MP3_CALC_HOW_MUCH_IS 411
	#define MP3_CALC_PLUS 412
	#define MP3_CALC_MINUS 413
	#define MP3_CALC_TIMES 414
	#define MP3_CALC_DIV_BY 415
	#define MP3_CALC_EQUALS 416
	#define MP3_CALC_TRY_AGAIN 417
	#define MP3_CALC_CALC_WITH_ME 418
	#define MP3_CALC_BIG_NUMBERS 419
	#define MP3_CALC_CORRECT 420
	#define MP3_CALC_WRONG 421
	#define MP3_CALC_BASIC_ARITH_OP 422
	#define MP3_CALC_ARITH_OP_INTRO 423
	#define MP3_CALC_ADD 424
	#define MP3_CALC_SUB 425
	#define MP3_CALC_MULT 426
	#define MP3_CALC_DIV 427
	#define MP3_CALC_ALL_OP 428
	#define MP3_CALC_MAX_NUM 429
	...
	#define MP3_LOCK_ADMIN 912
  	#define MP3_CONFIGURE_LIGHT 913
	#define MP3_CONFIGURE_LIGHT_BRIGHTNESS 914
	#define MP3_PROGRAMMING_MODE 915
	...
	#define MP3_CONFIGURE_STARTUP_SHORTCUT 944
  	#define MP3_CONFIGURE_LIGHT_INTRO 950
	#define MP3_CONFIGURE_LIGHT_BRIGHTNESS_INTRO 953
	...
	#define MP3_CONFIGURE_MODIFIER_CALCULATION 977
	...
	#define MP3_INTRO 998
	#define MP3_MINUTE 270
	#define MP3_MINUTES 271

	#define MP3_MODIFIER_SLEEP 971 //302
	#define MP3_MODIFIER_LOCKED 973 //303
	#define MP3_MODIFIER_BUTTONS_LOCKED 974 //304
	#define MP3_MODIFIER_DAYCARE_MODE 975 //305
	#define MP3_MODIFIER_REPEAT 976 //306
	#define MP3_LOCKED_SOUND 261
	#define MP3_MODIFIER_REMOVED_SOUND 260
	#define MP3_FREEZE_INTRO 262
	
	#define MODIFIER_CALC_LEARN_MODE_ADD 1
	#define MODIFIER_CALC_LEARN_MODE_SUB 2
	#define MODIFIER_CALC_LEARN_MODE_MULT 3
	#define MODIFIER_CALC_LEARN_MODE_DIV 4
	#define MODIFIER_CALC_LEARN_MODE_ALL 5
#endif
